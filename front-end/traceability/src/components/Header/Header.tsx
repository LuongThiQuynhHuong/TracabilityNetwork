          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="ms-auto">
              ...
              <NavDropdown title="Processor" id="basic-nav-dropdown" align="end">
                ...
                <NavDropdown.Item onClick={() => onMenuClick(LINK_PACKAGE_WITH_SHIPMENT, OrganizationKey.Processor)}>{LINK_PACKAGE_WITH_SHIPMENT_TITLE}</NavDropdown.Item>
