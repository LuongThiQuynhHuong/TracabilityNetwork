...
function createOrderer() {
  echo "Enrolling the CA admin"
  mkdir -p organizations/ordererOrganizations/ptracing.com

  export FABRIC_CA_CLIENT_HOME=${PWD}/organizations/ordererOrganizations/ptracing.com
  ...
  OrdererOUIdentifier:
    Certificate: cacerts/localhost-9054-ca-regulatoryDepartmentOrderer.pem
    OrganizationalUnitIdentifier: orderer' > "${PWD}/organizations/ordererOrganizations/ptracing.com/msp/config.yaml"

  # Since the CA serves as both the organization CA and TLS CA, copy the org's root cert that was generated by CA startup into the org level ca and tlsca directories

  # Copy orderer org's CA cert to orderer org's /msp/tlscacerts directory (for use in the channel MSP definition)
  mkdir -p "${PWD}/organizations/ordererOrganizations/ptracing.com/msp/tlscacerts"
  cp "${PWD}/organizations/fabric-ca/regulatoryDepartmentOrderer/ca-cert.pem" "${PWD}/organizations/ordererOrganizations/ptracing.com/msp/tlscacerts/tlsca.ptracing.com-cert.pem"

  # Copy orderer org's CA cert to orderer org's /tlsca directory (for use by clients)
  mkdir -p "${PWD}/organizations/ordererOrganizations/ptracing.com/tlsca"
  cp "${PWD}/organizations/fabric-ca/regulatoryDepartmentOrderer/ca-cert.pem" "${PWD}/organizations/ordererOrganizations/ptracing.com/tlsca/tlsca.ptracing.com-cert.pem"
  ...
  set -x
  fabric-ca-client enroll -u https://ordererAdmin:ordererAdminpw@localhost:9054 --caname ca-regulatoryDepartmentOrderer -M "${PWD}/organizations/ordererOrganizations/ptracing.com/users/Admin@ptracing.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/regulatoryDepartmentOrderer/ca-cert.pem"
  { set +x; } 2>/dev/null
