...
export ORDERER_CA=${PWD}/organizations/ordererOrganizations/ptracing.com/orderers/regulatorDepartmentOrderer.ptracing.com/msp/tlscacerts/tlsca.ptracing.com-cert.pem

export ORDERER_ADMIN_TLS_SIGN_CERT=${PWD}/organizations/ordererOrganizations/ptracing.com/orderers/regulatorDepartmentOrderer.ptracing.com/tls/server.crt

export ORDERER_ADMIN_TLS_PRIVATE_KEY=${PWD}/organizations/ordererOrganizations/ptracing.com/orderers/regulatorDepartmentOrderer.ptracing.com/tls/server.key
...
peer channel fetch config ${PWD}/channel-artifacts/config_block.pb -o localhost:7050 --ordererTLSHostnameOverride regulatorDepartmentOrderer.ptracing.com -c $CHANNEL_NAME --tls --cafile $ORDERER_CA
sleep 1
...
peer channel update -f ${PWD}/channel-artifacts/config_update_in_envelope.pb -c $CHANNEL_NAME -o localhost:7050  --ordererTLSHostnameOverride regulatorDepartmentOrderer.ptracing.com --tls --cafile $ORDERER_CA
sleep 1
...
peer lifecycle chaincode approveformyorg -o localhost:7050 --ordererTLSHostnameOverride regulatorDepartmentOrderer.ptracing.com --channelID $CHANNEL_NAME --name PTracing-supply-chain --version 1.0 --package-id $CC_PACKAGE_ID --sequence 1 --tls --cafile $ORDERER_CA --waitForEvent
sleep 2
...
export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/farm.ptracing.com/peers/peer1.farm.ptracing.com/tls/ca.crt
export CORE_PEER_MSPCONFIGPATH=${PWD}/organizations/peerOrganizations/farm.ptracing.com/users/Admin@farm.ptracing.com/msp
...
# peer lifecycle chaincode approveformyorg -o localhost:7050 --ordererTLSHostnameOverride regulatorDepartmentOrderer.ptracing.com --channelID $CHANNEL_NAME --name PTracing-supply-chain --version 1.0 --collections-config ../chaincode/Supply-chain/collection-supplychain.json --package-id $CC_PACKAGE_ID --sequence 1 --tls --cafile $ORDERER_CA --waitForEvent
# sleep 2
...
peer lifecycle chaincode commit -o localhost:7050 --ordererTLSHostnameOverride regulatorDepartmentOrderer.ptracing.com --channelID $CHANNEL_NAME --name PTracing-supply-chain --version 1.0 --sequence 1 --tls --cafile $ORDERER_CA --peerAddresses localhost:7051 --tlsRootCertFiles $regulatoryDepartment_PEER_TLSROOTCERT --peerAddresses localhost:9051 --tlsRootCertFiles $farm_PEER_TLSROOTCERT --peerAddresses localhost:8051 --tlsRootCertFiles $processor_PEER_TLSROOTCERT --peerAddresses localhost:11051 --tlsRootCertFiles $distributor_PEER_TLSROOTCERT
sleep 1
